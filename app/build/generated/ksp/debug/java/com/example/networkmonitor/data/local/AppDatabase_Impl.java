...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `connection_logs` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `state` TEXT NOT NULL, `transport` TEXT NOT NULL, `isValidated` INTEGER NOT NULL, `timestamp` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '4567e9b4eeccb29d0b1e07d0e003d286')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsConnectionLogs = new HashMap<String, TableInfo.Column>(5);
        _columnsConnectionLogs.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsConnectionLogs.put("state", new TableInfo.Column("state", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsConnectionLogs.put("transport", new TableInfo.Column("transport", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsConnectionLogs.put("isValidated", new TableInfo.Column("isValidated", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoConnectionLogs.equals(_existingConnectionLogs)) {
          return new RoomOpenHelper.ValidationResult(false, "connection_logs(com.example.networkmonitor.data.local.ConnectionLogEntity).\n"
                  + " Expected:\n" + _infoConnectionLogs + "\n"
                  + " Found:\n" + _existingConnectionLogs);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "4567e9b4eeccb29d0b1e07d0e003d286", "1222dc58d7ede8d5a6049c899e16499f");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "connection_logs");
  }
